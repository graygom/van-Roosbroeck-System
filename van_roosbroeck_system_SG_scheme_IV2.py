    ...
    for sweep_loop_no in wl_bias_sweep_info.keys():
        ...
        for each_div_index in range(range_div):
            ...
            for each_time_index, each_time in enumerate(timeline_full):
                ...
                old_v2 = grid_solver.V2
                old_n2 = grid_solver.n2
                ...
                while error_n > gi_error_n:
                    ...
                    # mixing decoupled solutions 1
                    grid_solver.V2[:,1:-1] = old_v2[:,1:-1] * gi_w + grid_solver.V2[:,1:-1] * ( 1.0 - gi_w )
                    grid_solver.V1 = grid_solver.V2.reshape(-1)
                    # mixing decoupled solutions 2
                    grid_solver.n1 = old_n1 * gi_w + grid_solver.n1 * ( 1.0 - gi_w )
                    grid_solver.n2 = grid_solver.n1.reshape(grid_solver.Z_nodes_len, grid_solver.R_nodes_len).T
                    # mixing decoupled solutions 3
                    grid_solver.p1 = old_p1 * gi_w + grid_solver.p1 * ( 1.0 - gi_w )
                    grid_solver.p2 = grid_solver.p1.reshape(grid_solver.Z_nodes_len, grid_solver.R_nodes_len).T
